...
public class TicketBooker {
    ...
    static Queue <Integer> waitingList = new LinkedList<>();//queue of WL passengers(First In First Out)
    static Queue<Integer> racList =  new LinkedList<>();//queue of RAC passengers(First In First Out)
    static List<Integer> bookedTicketList =  new ArrayList<>();//list of bookedticket passengers

    static List<Integer> lowerBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5,6,7,8,9));
    static List<Integer> middleBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5,6,7,8,9));
    static List<Integer> upperBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5,6,7,8,9));
    ...
    public void cancelTicket(int passengerId)
    {
        ...
        if(racList.size() > 0)
        {
            ...
            Train_Reservation.bookTicket(passengerFromRAC);
        }
